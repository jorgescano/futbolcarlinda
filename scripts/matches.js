            ...
            if (v.Text != null) {
                ...
                score.append(
                    $('<span/>')
                        ...
                        .append($('<span/>', { text: viewManagement.common.isNullOrEmpty(v.LocalScore) ? '?' : v.LocalScore }))
                );
                score.append($('<span/>', { class: 'mx-2', text: '-' }));
                score.append(
                    $('<span/>')
                        .append($('<span/>', { text: viewManagement.common.isNullOrEmpty(v.AwayScore) ? '?' : v.AwayScore }))
